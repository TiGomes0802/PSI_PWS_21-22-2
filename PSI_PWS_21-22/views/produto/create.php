...
<div class="row">
    <div class="col-sm-12">
        <form action="./router.php?c=produto&a=store" method="POST">
            ...
            <input class="input-forms" type="text" name="referencia" value="<?php if(isset($produto)) { echo $produto->referencia; }?>">
            <p><?php
            ...
            <input class="input-forms" type="text"   name="descricao" value="<?php if(isset($produto)) { echo $produto->descricao; }?>">
            <p><?php
                if(isset($produto->errors)) {
            ...
            <input class="input-forms" type="number" min="0" step="0.01" name="preco" value="<?php if(isset($produto)) { echo $produto->preco; }else{echo '0';}?>">
            <p><?php
                if(isset($produto->errors)) {
            ...
            <input class="input-forms" type="number" min="0" name="stock" value="<?php if(isset($produto)) { echo $produto->stock; }else{echo '0';}?>">
            <p><?php
                if(isset($produto->errors)) {
            ...
            <select class="input-forms" name="iva_id">
                <?php foreach($ivas as $iva){?>
                    <option value="<?= $iva->id?>"> <?= $iva->percentagem; ?>%</option>
                <?php } ?>
            </select>
            <p>
            <input class="input-forms" type="submit" value="Criar Produto">
        </form>
    </div>
</div>