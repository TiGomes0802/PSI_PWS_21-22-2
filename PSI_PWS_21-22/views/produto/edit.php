...
<div class="row">
    <div class="col-sm-12">
        <form action="./router.php?c=produto&a=update&id=<?=$produto->id?>" method="POST">
            ...
            <input class="input-forms" type="text" name="id" value="<?=$produto->id?>" disabled><br>
            <p></p>
            <label for="referencia">Referência:</label><br>
            <input class="input-forms" type="text" name="referencia" value="<?=$produto->referencia?>"disabled><br>
            <p><?php if(isset($produto->errors)){ echo $produto->errors->on('referencia'); }?></p>
            <p></p>
            <label for="descricao">Descrição:</label><br>
            <input class="input-forms" type="text" name="descricao" value="<?=$produto->descricao?>"disabled><br>
            <p><?php if(isset($produto->errors)){ echo $produto->errors->on('descricao'); }?></p>
            <p></p>
            <label for="preco">Preço:</label><br>
            <input class="input-forms" type="number" step="0.01" min="0" name="preco" value="<?=$produto->preco?>"><brdisabled>
            <p><?php if(isset($produto->errors)){ echo $produto->errors->on('preco'); }?></p>
            <p></p>
            <label for="stock">Stock:</label><br>
            <input class="input-forms" type="number" min="0" name="stock" value="<?=$produto->stock?>"><br>
